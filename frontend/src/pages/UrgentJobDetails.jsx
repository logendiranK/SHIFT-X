...
const UrgentJobDetails = () => {
  ...
  return (
    <div className="job-details-container">
      ...
      <p><strong>Duration (hours):</strong> {job.durationHours}</p>
      <p><strong>Shift Date:</strong> {job.shiftDate}</p>
      <p><strong>Shift Start:</strong> {job.shiftStartTime}</p>
      <p><strong>Shift End:</strong> {job.shiftEndTime}</p>
